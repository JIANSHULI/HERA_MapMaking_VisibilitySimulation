...
plt.subplot(2,2,1)
plt.imshow(np.angle(omnifits['xy'][..., redundancy_sort[-1]]), interpolation='none', aspect=1/np.e)
plt.subplot(2,2,2)
plt.imshow(np.angle(omnifits['xy'][..., redundancy_sort[-10]]), interpolation='none', aspect=1/np.e)
for pol in ['xy', 'yx']:
    tmp_t = 0
