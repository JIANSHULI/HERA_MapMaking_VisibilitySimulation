...
infofile = '/home/omniscope/omnical/doc/redundantinfo_X5_q3x.bin'#'/home/omniscope/omnical/doc/redundantinfo_PSA128_26ba_6bu_08-15-2014.bin'#
...
if all_ubl:
    A.tofile('/home/omniscope/simulate_visibilities/data/Amatrix_allubl_nside%i_%iby%i_'%(nside, len(A), len(A[0])) + infofile.split('/')[-1])
else:
    A.tofile('/home/omniscope/simulate_visibilities/data/Amatrix_%iubl_nside%i_%iby%i_'%(len(ubls), nside, len(A), len(A[0])) + infofile.split('/')[-1])
